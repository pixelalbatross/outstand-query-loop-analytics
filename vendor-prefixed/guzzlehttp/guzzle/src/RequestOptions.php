...
final class RequestOptions
{
    ...
    /**
     * body: (resource|string|null|int|float|bool|\Outstand\WP\QueryLoop\Analytics\Dependencies\Psr\Http\Message\StreamInterface|(callable&object)|\Iterator|\Stringable)
    ...
    /**
     * cookies: (false|Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Cookie\CookieJarInterface, default=false)
    ...
    /**
     * sink: (resource|string|\Outstand\WP\QueryLoop\Analytics\Dependencies\Psr\Http\Message\StreamInterface) Where the data
