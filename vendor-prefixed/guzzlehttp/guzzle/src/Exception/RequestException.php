...
namespace Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Exception;

use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\BodySummarizer;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\BodySummarizerInterface;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(
        ...
        $uri = \Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
