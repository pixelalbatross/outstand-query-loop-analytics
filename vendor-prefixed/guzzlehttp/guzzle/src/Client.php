...
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Cookie\CookieJar;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Cookie\CookieJarInterface;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Exception\GuzzleException;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Exception\InvalidArgumentException;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Handler\CurlShareHandleState;
 ...
 * @final
 */
class Client implements ClientInterface, \Outstand\WP\QueryLoop\Analytics\Dependencies\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
