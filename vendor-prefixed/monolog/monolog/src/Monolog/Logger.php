...
namespace Outstand\WP\QueryLoop\Analytics\Dependencies\Monolog;

use DateTimeZone;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Monolog\Handler\HandlerInterface;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Psr\Log\LoggerInterface;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \Outstand\WP\QueryLoop\Analytics\Dependencies\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
