 ...
 *
 * <code>
 * $application = new \Outstand\WP\QueryLoop\Analytics\Dependencies\Monolog\Logger('application');
 * $api = new \Outstand\WP\QueryLoop\Analytics\Dependencies\Monolog\Logger('api');
 *
