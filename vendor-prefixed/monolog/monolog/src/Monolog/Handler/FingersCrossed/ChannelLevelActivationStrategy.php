...
namespace Outstand\WP\QueryLoop\Analytics\Dependencies\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = array_map('Outstand\WP\QueryLoop\Analytics\Dependencies\Monolog\Logger::toMonologLevel', $channelToActionLevel);
    }
