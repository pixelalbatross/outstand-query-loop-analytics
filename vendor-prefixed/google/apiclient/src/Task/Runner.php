...
namespace Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Task;

use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Service\Exception as GoogleServiceException;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Task\Exception as GoogleTaskException;
...
class Runner
{
     ...
     * @throws \Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Task\Exception when misconfigured
     */
     ...
     *
     * @return mixed
     * @throws \Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Service\Exception on failure when no retries are available.
     */
    public function run()
    {
        while ($this->attempt()) {
