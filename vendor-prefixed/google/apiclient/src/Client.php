...
namespace Outstand\WP\QueryLoop\Analytics\Dependencies\Google;

use BadMethodCallException;
use DomainException;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\AccessToken\Revoke;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\AccessToken\Verify;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\ApplicationDefaultCredentials;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\Cache\MemoryCacheItemPool;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\Credentials\ServiceAccountCredentials;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\Credentials\UserRefreshCredentials;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\CredentialsLoader;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\FetchAuthTokenCache;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\FetchAuthTokenInterface;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\GetUniverseDomainInterface;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\HttpHandler\HttpHandlerFactory;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\OAuth2;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\AuthHandler\AuthHandlerFactory;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Http\REST;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Client as GuzzleClient;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\ClientInterface;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Monolog\Handler\StreamHandler as MonologStreamHandler;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Monolog\Logger;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Psr\Cache\CacheItemPoolInterface;
...
class Client
{
     ...
     * @throws \Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Exception
