...
namespace Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Service;

use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Exception as GoogleException;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Http\MediaFileUpload;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Model;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Utils\UriTemplate;
...
class Resource
{
    ...
    /** @var \Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Client $client */
    private $client;
