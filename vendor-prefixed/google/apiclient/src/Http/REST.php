...
namespace Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Http;

use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\HttpHandler\HttpHandlerFactory;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Service\Exception as GoogleServiceException;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Task\Runner;
...
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Psr7\Response;
...
class REST
{
     ...
     * @return mixed|T|null
     * @throws \Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Service\Exception on server side error (ie: not authenticated,
