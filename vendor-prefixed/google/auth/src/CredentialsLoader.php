...
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\Credentials\ExternalAccountAuthorizedUserCredentials;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\Credentials\ExternalAccountCredentials;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\Credentials\InsecureCredentials;
    ...
    UpdateMetadataInterface
{
     ...
     * @return \Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Client
     */
    public static function makeHttpClient(
        ...
        $stack = \Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
