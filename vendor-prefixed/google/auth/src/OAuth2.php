...
use Outstand\WP\QueryLoop\Analytics\Dependencies\Firebase\JWT\Key;
...
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Psr7\Query;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Psr7\Request;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Psr7\Utils;
...
class OAuth2 implements FetchAuthTokenInterface
{
     ...
     * @throws \Outstand\WP\QueryLoop\Analytics\Dependencies\Firebase\JWT\SignatureInvalidException If the signature is invalid.
     * @throws \Outstand\WP\QueryLoop\Analytics\Dependencies\Firebase\JWT\BeforeValidException If the token is not yet valid.
     * @throws \Outstand\WP\QueryLoop\Analytics\Dependencies\Firebase\JWT\ExpiredException If the token has expired.
     * @return null|object
     */
