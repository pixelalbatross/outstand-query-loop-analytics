...
namespace Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\Credentials;

use COM;
use com_exception;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\CredentialsLoader;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\GetQuotaProjectInterface;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\HttpHandler\HttpClientCache;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\HttpHandler\HttpHandlerFactory;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\Iam;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\IamSignerTrait;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\ProjectIdProviderInterface;
use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\SignBlobInterface;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Exception\ClientException;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Exception\ConnectException;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Exception\RequestException;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Exception\ServerException;
use Outstand\WP\QueryLoop\Analytics\Dependencies\GuzzleHttp\Psr7\Request;
 ...
 *
 * ```
 * use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\Credentials\GCECredentials;
 * use Outstand\WP\QueryLoop\Analytics\Dependencies\Google\Auth\Middleware\AuthTokenMiddleware;
    ...
    GetQuotaProjectInterface
{
     ...
     */
    private const PRODUCT_NAME = 'Outstand\WP\QueryLoop\Analytics\Dependencies\Google';
            ...
            try {
                ...
                $resp = $httpHandler(
                    new Request(
                        ...
                        $checkUri,
                        [
                            self::FLAVOR_HEADER => 'Outstand\WP\QueryLoop\Analytics\Dependencies\Google',
                ...
                return $resp->getHeaderLine(self::FLAVOR_HEADER) == 'Outstand\WP\QueryLoop\Analytics\Dependencies\Google';
    ...
    private function getFromMetadata(callable $httpHandler, $uri, array $headers = [])
    {
        $resp = $httpHandler(
            new Request(
                'GET',
                $uri,
                [self::FLAVOR_HEADER => 'Outstand\WP\QueryLoop\Analytics\Dependencies\Google'] + $headers
            )
        );
